...
import org.tempeh.xbrl.XbrlConstants;
...
public class XLinkProcessor {
     ...
     */
    private IXLinkHandler xlinkHandler;
     ...
     */
    //private ICustomLinkRecogniser customLinkRecogniser;
     ...
     */
    public XLinkProcessor(IXLinkHandler xlinkHandler) {
        super();
        initialize(xlinkHandler);
    }

    private void initialize(IXLinkHandler xlinkHandler) {
     ...
     */
    /*
    public XLinkProcessor(IXLinkHandler xlinkHandler, ICustomLinkRecogniser recogniser) {
        this(xlinkHandler);
    ...
    /*
    public void setCustomLinkRecogniser(ICustomLinkRecogniser customLinkRecogniser) {
    ...
    public void startElement(String namespaceURI, String lName, String qName, Attributes attrs) throws XLinkException {
        ...
        for (int i=0; i<attrs.getLength(); i++) {
            if (attrs.getURI(i).equals(XbrlConstants.XLinkNamespace.toString())) {
        ...
        String href = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "href");
        String role = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "role");
        String arcrole = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "arcrole");
        String from = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "from");
        String to = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "to");
        String title = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "title");
        String show = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "show");
        String actuate = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "actuate");
        String label = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "label");
        String type = attrs.getValue(XbrlConstants.XLinkNamespace.toString(), "type");        
     ...
     */
    public IXLinkHandler getXLinkHandler() {
        return xlinkHandler;
    }
